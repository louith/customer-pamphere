...
class _AllWorkersState extends State<AllWorkers> {
  ...
  Future<AllWorkerCard?> getAllWorkerCard(String plainID) async {
    ...
    Stream<QuerySnapshot<Map<String, dynamic>>> snapshot = await FirebaseFirestore.instance
        .collection('users')
        .doc(plainID)
  ...
  AsyncSnapshot<QuerySnapshot> snapshot;
    ...
    for (DocumentSnapshot catdoc in snapshot.) {
      Map<String, dynamic> data = catdoc.data() as Map<String, dynamic>;
                ...
                child: ListTile(
                  ...
                  title: Column(
                    ...
                    children: [
                      ...
                      CategoriesRow(itemList: allWorkers[index].subcategories),
